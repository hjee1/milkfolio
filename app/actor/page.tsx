...
// 학력·본업이 제거되었고 Profile/Reel/Filmography 컴포넌트는 데이터 그대로
// 렌더한다 — data.ts가 본 페이지의 페르소나 분리 single source of truth이다.
//
// @MX:SPEC: SPEC-ACTOR-REDESIGN-001 Phase 0+1+2+3
export default function ActorPage() {
  return (
    <div className={styles.body} data-actor-body>
      ...
      {/* TODO Phase 4: Roles 섹션을 Reel과 Filmography 사이에 삽입한다.
          (Hero → Profile → Reel → Roles → Filmography → Contact가 최종 순서.) */}
